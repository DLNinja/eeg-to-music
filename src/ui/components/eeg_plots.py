...
class EmotionPlotWidget(QWidget):
    #Draws emotion probability curves + play cursor
...
class BandZScorePlotWidget(QWidget):
    #Displays 5 EEG band Z-scores over time.
...
class AsymmetryGaugeWidget(QWidget):
    #Displays Frontal Alpha Asymmetry
    ...
    def __init__(self, parent=None):
        ...
        self.axis_color = QColor("#888899")
        self.label_color = QColor("#ccccdd")
        self.left_color = QColor("#FCA5A5")   # Red (withdrawal)
        self.right_color = QColor("#00FFB2")  # Green (approach)
